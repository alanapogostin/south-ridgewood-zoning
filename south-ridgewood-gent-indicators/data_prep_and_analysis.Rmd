...
census_ <-  census_19 %>% 
  bind_rows(census_14)
            # , by = c("pov_pctM", "hh_size_avgE", "hh_size_avgM", "occ_unitsE", "occ_unitsM", "occ_renter_unitsE", "occ_renter_unitsM", "vac_forrent_unitsE", "vac_forrent_unitsM", "vac_rented_unitsE", "vac_rented_unitsM", "occ_ownerE", "occ_ownerM", "year"))
```
# 2015-2019 Data Wrangling
```{r}
hh_rent_burden <- census_ %>%
  select("gross_rent_medE", "hh_inc_medE", "rent_burden_medE") %>%
  group_by("year") %>%
